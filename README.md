...
# 3. Preverba
./rob test          # 375 testov — mora biti 100% zeleno
...
| Ukaz | Kaj naredi |
|---|---|
| `./rob test` | Celotna testna matrika (375 testov) |
...
│   ├── actions_runtime.py  #   34 API modulov kot enotna app (:8788)
...
└── tests/                  # 39 test datotek, 375 testov
```
...
- **Poln suite:** `375` testov / `39` datotek — vodi `./rob test` (`pytest tests/`).
